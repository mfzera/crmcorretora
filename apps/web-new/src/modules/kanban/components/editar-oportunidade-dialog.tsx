...
import { Clock, Edit, Flame, TrendingUp, UserPlus } from 'lucide-react';
import { cn } from '@/core/utils';
import { useUpdateOportunidade } from '../http';
...
export function EditarOportunidadeDialog({ oportunidade, open, onOpenChange }: EditarOportunidadeDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[760px] max-h-[88vh] gap-0 p-0 overflow-hidden">
        <div className="flex flex-col h-full max-h-[88vh]">
          ...
          <div className="flex items-center gap-3 border-b px-6 py-4 pr-14 shrink-0">
            ...
            <DialogHeader className="p-0 space-y-0">
              <DialogTitle className="text-base font-semibold">Editar Oportunidade</DialogTitle>
            </DialogHeader>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6">
            {isLoading ? (
              ...
              <Form {...form}>
                <form id="editar-oportunidade-form" onSubmit={form.handleSubmit(onSubmit as any)} className="space-y-6">
                          ...
                          <FormItem>
                            ...
                            <div className="flex gap-2">
                              ...
                              <Button type="button" variant="outline" size="icon" className="shrink-0"
                                onClick={() => setShowAdicionarCliente(true)} title="Adicionar novo cliente">
          ...
          <div className="flex items-center justify-end gap-2 border-t px-6 py-4 shrink-0 bg-background/50">
            ...
            <Button type="submit" form="editar-oportunidade-form" size="sm" disabled={updateOportunidade.isPending || isLoading}>
      ...
      <NovoClienteDialog
        ...
        onClienteCriado={(cliente) => { form.setValue('nomeCliente', cliente.nome); setShowAdicionarCliente(false); }}
      />
    </Dialog>
  );
}
