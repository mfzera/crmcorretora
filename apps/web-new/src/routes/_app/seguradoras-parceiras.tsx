...
export const Route = createFileRoute('/_app/seguradoras-parceiras')({
  component: SeguradorasParceiraPage,
});


type StatusFilter = 'ATIVA' | 'INATIVA' | 'TODAS';

function SeguradorasParceiraPage() {
  ...
  return (
    <div className="space-y-8 p-4 md:p-8">
      <PageHeader
        ...
        description="Gerencie as seguradoras parceiras com quem sua corretora trabalha"
        actions={hasPermission ? <SeguradoraDialog onSuccess={() => refetch()} /> : undefined}
      />
